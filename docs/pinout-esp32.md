...
GPIO35, GPIO36, and GPIO37 are not assigned because they are unavailable on
the N16R8 module variant. Avoid boot-strapping pins for attached peripherals
until their boot-time levels are audited.
